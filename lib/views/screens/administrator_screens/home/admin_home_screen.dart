...
//                       ),
//                       onPressed: () async {
//                         await Get.to(() => AdminProfileScreen());
//                       },
//                     ),
//                     IconButton(
//                       icon: Icon(
...
//                                           as ImageProvider,
//                                 ),
//                                 if (adminHomeController.adminModel.value
...
//               onTap: () async {
//                 await Get.to(() => AdminProfileScreen()); // Close the drawer
//               },
//             ),
//             ListTile(
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                // Top Bar with Menu, Time, and Icons
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Builder(
                  ...
                  child: Row(
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsets.symmetric(horizontal: 10.w),
                        child: Obx(() {
                          final hasImage = adminHomeController
                              .adminModel.value.profileImageUrl.isNotEmpty;
                          return Stack(
                            alignment: Alignment.center,
                            children: [
            ...
            child: GridView.count(
              ...
              children: [
                ...
                _buildDashboardItem(
                  title: "Notice",
                  image: AppImage.notice,
                  onTap: () => Get.to(() => StudentAnnouncementScreen()),
                ),
                _buildDashboardItem(
                  title: "Staff Profile",
                  image: AppImage.staffProfile,
                  onTap: () => Get.to(() => StaffListScreen()),
                ),
                _buildDashboardItem(
                  title: "College Info",
                  image: AppImage.collegeInfo,
                  onTap: () => Get.to(() => CollegeInfoScreen()),
                ),
                _buildDashboardItem(
                  title: "Event",
                  image: AppImage.event,
                  onTap: () => Get.to(() => FacultyEventScreen()),
                ),
                _buildDashboardItem(
                  title: "Gallery",
                  image: AppImage.gallery,
                  onTap: () => Get.to(() => AdminGalleryScreen()),
                ),
                _buildDashboardItem(
                  title: "Fee payment",
                  image: AppImage.feePayment,
                  onTap: () => Get.to(() => SetPaymentAmountScreen()),
                ),
                _buildDashboardItem(
                  title: "Contact Us",
                  image: AppImage.contactus,
        ...
        child: ListView(
          ...
          children: [
            ...
            _buildDrawerItem(
              icon: Icons.person,
              title: 'Add Faculty',
              onTap: () => Get.to(() => FacultyRegistrationScreen()),
            ),
            _buildDrawerItem(
              icon: Icons.person,
              title: 'Profile',
            ...
            _buildDrawerItem(
              ...
              title: 'Share',
              onTap: () => Share.share("Share CollegeApp"),
            ),
            _buildDrawerItem(
