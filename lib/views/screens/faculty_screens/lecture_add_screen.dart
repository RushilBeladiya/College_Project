...
//             children: [
//               /// **Professor Name**
//               Text("Professor Name", style: TextStyle(fontWeight: FontWeight.bold)),
//               Obx(
//                     () => TextField(
//                   readOnly: true,
//                   decoration: InputDecoration(
//                     hintText: "${facultyHomeController.facultyModel.value.firstName} ${facultyHomeController.facultyModel.value.surName}",
...
//                 items: lectureController.streamSemesterSubjects.keys.map((stream) {
...
//                   lectureController.selectedSemester.value = null; // Reset Semester
//                   lectureController.selectedDivision.value = null; // Reset Division
//                   lectureController.selectedSubject.value = null; // Reset Subject
//                 },
...
//                     ? lectureController
//                     .streamSemesterSubjects[lectureController.selectedStream.value]!
//                     .keys
...
//               /// **Lecture Start Time**
//               Text("Lecture Start Time", style: TextStyle(fontWeight: FontWeight.bold)),
//               Obx(() => TextField(
//                 readOnly: true,
//                 decoration: InputDecoration(
...
//               /// **Lecture End Time**
//               Text("Lecture End Time", style: TextStyle(fontWeight: FontWeight.bold)),
//               Obx(() => TextField(
//                 readOnly: true,
//                 decoration: InputDecoration(
...
//                       ? "Select Date"
//                       : DateFormat('dd-MM-yyyy').format(lectureController.selectedDate.value!),
...
// }
import 'package:college_project/controller/Faculty/home/faculty_home_controller.dart';
import 'package:college_project/core/utils/colors.dart'; // Import AppColor
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:intl/intl.dart';
...
class LectureAddScreen extends StatefulWidget {
  const LectureAddScreen({super.key});
...
class _LectureAddScreenState extends State<LectureAddScreen> {
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              /// **Professor Name**
              _buildSectionTitle("Professor Name"),
              Obx(() => TextField(
                    readOnly: true,
                    decoration: InputDecoration(
                      hintText:
              ...
              Obx(() => DropdownButtonFormField<String>(
                    ...
                    onChanged: (value) {
                      lectureController.selectedStream.value = value;
                      lectureController.selectedSemester.value = null;
                      lectureController.selectedDivision.value = null;
                      lectureController.selectedSubject.value = null;
                    },
              ...
              /// **Lecture Start Time**
              _buildSectionTitle("Lecture Start Time"),
              Obx(() => TextField(
                    readOnly: true,
                    decoration: _timeInputDecoration(
                      lectureController.startTime.value == null
                          ? "Select Start Time"
                          : lectureController.startTime.value!.format(context),
                    ),
                    onTap: () => lectureController.selectTime(context, true),
              ...
              /// **Lecture End Time**
              _buildSectionTitle("Lecture End Time"),
              Obx(() => TextField(
                    readOnly: true,
                    decoration: _timeInputDecoration(
                      lectureController.endTime.value == null
                          ? "Select End Time"
                          : lectureController.endTime.value!.format(context),
                    ),
                    onTap: () => lectureController.selectTime(context, false),
              ...
              Obx(() => TextField(
                    readOnly: true,
                    decoration: _timeInputDecoration(
                      lectureController.selectedDate.value == null
                          ? "Select Date"
  ...
  /// Reusable input decoration with AppColor
  ...
  /// Time input decoration with AppColor
  InputDecoration _timeInputDecoration(String hintText) {
    return InputDecoration(
      hintText: hintText,
