import 'package:college_project/views/screens/faculty_screens/attendance_screen/faculty_attendance_taking_screen.dart';
import 'package:college_project/views/screens/faculty_screens/attendance_screen/faculty_class_create_screen.dart';
      ...
      body: _isLoading
          ? Center(
              child: CircularProgressIndicator(
                color: AppColor.primaryColor, // Set loader color to primary
              ),
            )
          : Container(
                      ...
                      builder:
                        ...
                        createdClasses = createdClasses.where((classData) {
                          return classData['facultyPhoneNumber'] ==
                              _facultyHomeController
                                  .facultyModel.value.phoneNumber;
                        }).toList();
